...
public class LDADataset {
	...
	public void setDoc(String str, int idx){
		if (0 <= idx && idx < M){
			...
			HashMap<Integer,Double> tfids = new HashMap<Integer,Double>();
			
			Vector<Integer> ids = new Vector<Integer>();
			
			for (String oldWord : words){
				int _id = localDict.word2id.size();
				
				String[] wordScore = oldWord.split("-<");
				String word = wordScore[0];
				Double score = Double.valueOf(wordScore[1].replace(">", ""));
